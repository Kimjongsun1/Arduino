////////////////  LINE SENSOR  ///////////////
int line_sensor_pin[5] = { 34,35, 36, 37, 38 }; // Line Sensor Pin배열을 선언
...
int read_line_sensor(void)
{
  ...
  // line sensor[0]   line sensor[0]    line sensor[0]    line sensor[0]    line sensor[0]
  //     -4        -3      -2        -1       0        1        2        3        4
